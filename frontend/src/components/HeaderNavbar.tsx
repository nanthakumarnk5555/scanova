            ...
            <div className="hidden lg:flex items-center p-0.5 rounded-full bg-slate-100 border border-slate-200 text-[10px]">
              {(['clinician', 'radiologist', 'admin'] as const).map((r) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-full font-bold capitalize transition-all cursor-pointer ${currentRole === r
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-xl text-xs font-bold transition-all duration-200 whitespace-nowrap cursor-pointer select-none font-display ${isActive
                    ...
                    >
                      ...
                      {item.badge && (
                        <span
                          className={`text-[9px] font-mono px-1.5 py-0.2 rounded-full uppercase font-bold ${item.isAlert
