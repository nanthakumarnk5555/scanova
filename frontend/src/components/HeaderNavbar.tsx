  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        { id: 'platform_overview', label: 'Architecture & Pipeline', icon: Sparkles },
        { id: 'cxr_scan', label: 'AI Diagnostic Studio', icon: Zap, isCore: true },
        { id: 'doctor_review', label: 'Doctor Review', icon: FileCheck2 },
        { id: 'pneumonia_model', label: 'Pneumonia CXR Fleet', icon: Stethoscope, badge: 'DenseNet' },
        { id: 'bone_model', label: 'Bone Fracture Fleet', icon: Bone, badge: 'ResNet' },
      ]
    },
    {
          ...
          >
            <div className="relative w-9 h-9 flex items-center justify-center filter drop-shadow-sm group-hover:scale-105 transition-transform duration-200">
              <svg className="w-full h-full" viewBox="0 0 100 100" fill="none">
                <defs>
                  <linearGradient id="scanovaGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#2563EB" />
                    <stop offset="50%" stopColor="#4F46E5" />
                    <stop offset="100%" stopColor="#06B6D4" />
                  </linearGradient>
                  <linearGradient id="scanovaInner" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <polygon
                  ...
                  stroke="url(#scanovaGrad)"
                  strokeWidth="4"
                  fill="url(#scanovaInner)"
                />
                <line x1="50" y1="6" x2="50" y2="94" stroke="#4F46E5" strokeWidth="1.5" strokeOpacity="0.4" />
