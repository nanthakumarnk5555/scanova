...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-[calc(100vh-140px)] flex items-center justify-center p-4 sm:p-6 lg:p-8 animate-in fade-in duration-300">
      ...
      <div className="w-full max-w-5xl rounded-3xl bg-white border border-slate-200/90 shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 text-slate-900">
        ...
        <div className="lg:col-span-5 relative p-8 sm:p-10 bg-slate-50/80 border-b lg:border-b-0 lg:border-r border-slate-200 flex flex-col justify-between overflow-hidden">
          ...
          <div className="relative z-10 space-y-2">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-blue-50 text-blue-700 text-[10px] font-mono font-bold tracking-wider uppercase border border-blue-200">
          ...
          <div className="relative my-6 py-2 flex flex-col items-center justify-center">
            <div className="relative w-full max-w-[300px] aspect-square rounded-2xl bg-black border border-slate-800 shadow-lg overflow-hidden flex items-center justify-center group">
              ...
              {/* HUD Grid Overlay */}
              <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(37,99,235,0.1)_1px,transparent_1px),linear-gradient(to_bottom,rgba(37,99,235,0.1)_1px,transparent_1px)] bg-[size:16px_16px] pointer-events-none" />
              ...
              <div className="absolute bottom-2.5 right-2.5 pr-3 pb-1">
                <span className="text-[8px] font-mono text-cyan-300 font-bold tracking-wider">DENSENET-121</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-200 text-center font-mono">
            ...
            <div className="p-2 rounded-xl bg-white border border-slate-200">
              ...
              <p className="text-xs font-bold text-blue-600">~140ms</p>
            </div>
            <div className="p-2 rounded-xl bg-white border border-slate-200">
                ...
                <button
                  ...
                  className={`p-3 rounded-2xl border text-center transition-all cursor-pointer ${
                    role === 'radiologist' && email === 'radiologist@scanova.health'
                      ? 'bg-blue-600 text-white font-bold border-blue-600 shadow-md shadow-blue-600/25'
