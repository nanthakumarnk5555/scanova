  ...
  return (
    <div className="min-h-[calc(100vh-140px)] flex items-center justify-center p-4 sm:p-6 lg:p-8 animate-in fade-in duration-300">
      ...
      <div className="w-full max-w-5xl rounded-3xl bg-white border border-slate-200 shadow-xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 text-slate-900">
        ...
        <div className="lg:col-span-5 relative p-8 sm:p-10 bg-slate-50/80 border-b lg:border-b-0 lg:border-r border-slate-200 flex flex-col justify-between overflow-hidden">

          {/* Platform Identity */}
          <div className="relative z-10 space-y-2">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-blue-50 text-blue-800 text-[10px] font-mono font-bold tracking-wider uppercase border border-blue-200">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-600 animate-ping" />
              <span>Medical AI Platform</span>
            </div>

            <h1 className="text-3xl font-black tracking-tight text-slate-900 font-display">
              Continuous Radiograph Diagnostic AI
            </h1>

            <p className="text-xs text-slate-600 leading-relaxed font-sans">
              Clinical decision support powered by DenseNet-121 and Trauma ResNet-50 architectures with Grad-CAM visual explainability.
            </p>
          </div>

          {/* Holographic Radiograph Showcase */}
          <div className="relative my-6 py-2 flex flex-col items-center justify-center">
            <div className="relative w-full max-w-[300px] aspect-square rounded-2xl bg-black border border-slate-800 shadow-lg overflow-hidden flex items-center justify-center group">
              ...
              {/* HUD Grid Overlay */}
              <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(37,99,235,0.12)_1px,transparent_1px),linear-gradient(to_bottom,rgba(37,99,235,0.12)_1px,transparent_1px)] bg-[size:16px_16px] pointer-events-none" />
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-70">
                ...
                <div className="w-20 h-20 rounded-full border border-dashed border-blue-400/80 animate-spin" />
              </div>

              {/* Corner Brackets */}
              <div className="absolute top-2.5 left-2.5 w-3.5 h-3.5 border-t-2 border-l-2 border-blue-400 pointer-events-none" />
              <div className="absolute top-2.5 right-2.5 w-3.5 h-3.5 border-t-2 border-r-2 border-blue-400 pointer-events-none" />
              <div className="absolute bottom-2.5 left-2.5 w-3.5 h-3.5 border-b-2 border-l-2 border-blue-400 pointer-events-none" />
              <div className="absolute bottom-2.5 right-2.5 w-3.5 h-3.5 border-b-2 border-r-2 border-blue-400 pointer-events-none" />
              ...
              <div className="absolute bottom-2.5 right-2.5 pr-3 pb-1">
                <span className="text-[8px] font-mono text-cyan-300 font-bold tracking-wider">DUAL-ENGINE</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-200 text-center font-mono">
            <div className="p-2 rounded-xl bg-white border border-slate-200">
              <p className="text-[10px] text-slate-500 font-semibold">Models</p>
              <p className="text-xs font-bold text-slate-800">CXR + Bone</p>
            </div>
            <div className="p-2 rounded-xl bg-white border border-slate-200">
              <p className="text-[10px] text-slate-500 font-semibold">Latency</p>
              <p className="text-xs font-bold text-blue-600">~120ms</p>
            </div>
            <div className="p-2 rounded-xl bg-white border border-slate-200">
        ...
        <div className="lg:col-span-7 p-8 sm:p-10 flex flex-col justify-between bg-white">
          ...
          <div>
            ...
            <div className="flex items-center justify-between pb-6 border-b border-slate-100">
              ...
              <div className="w-10 h-10 rounded-2xl bg-blue-50 border border-blue-200 flex items-center justify-center text-blue-700 shadow-sm">
            ...
            <div className="mt-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] font-mono text-blue-600 font-semibold">1-Click Auto-Fill</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2.5">
                <button
                  ...
                  className={`p-3 rounded-2xl border text-center transition-all cursor-pointer ${
                    role === 'radiologist' && email === 'radiologist@scanova.health'
                      ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold border-blue-600 shadow-md shadow-blue-600/25'
                      : 'bg-slate-50 border-slate-200 text-slate-700 hover:bg-blue-50/50 hover:border-blue-300'
                  }`}
                >
                  <Activity className={`w-4 h-4 mx-auto mb-1 ${role === 'radiologist' && email === 'radiologist@scanova.health' ? 'text-white' : 'text-blue-600'}`} />
                ...
                >
                  <Stethoscope className={`w-4 h-4 mx-auto mb-1 ${role === 'clinician' && email === 'clinician@scanova.health' ? 'text-white' : 'text-blue-600'}`} />
            ...
            {successMessage && (
              <div className="mt-4 p-3 rounded-2xl bg-blue-50 border border-blue-300 flex items-center space-x-2.5 text-blue-800 text-xs animate-in fade-in">
            ...
            <form onSubmit={isSignUp ? handleSignUp : handleSignIn} className="mt-5 space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-300 focus:border-blue-500 focus:bg-white rounded-2xl text-xs text-slate-900 placeholder-slate-400 outline-none transition-all"
                      required
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-3 bg-slate-50 border border-slate-300 focus:border-blue-500 focus:bg-white rounded-2xl text-xs text-slate-900 placeholder-slate-400 outline-none transition-all"
                    required
                  />
                  <button
                    type="button"
              ...
              {!isSignUp && (
                <div className="flex items-center justify-between text-xs pt-1">
                  ...
                  <button
                    ...
                    className="text-[11px] text-blue-700 hover:text-blue-800 font-semibold transition-colors cursor-pointer"
                  >
                    Forgot Password?
                  </button>
                </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 px-4 rounded-full font-bold text-xs bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-md shadow-blue-600/30 flex items-center justify-center space-x-2 transition-all duration-300 group active:scale-[0.99] disabled:opacity-60 cursor-pointer"
              >
                {loading ? (
              ...
              {isSignUp ? (
                <p>
                  ...
                  <button
                    ...
                    className="text-blue-700 hover:underline underline-offset-2 ml-1 font-semibold cursor-pointer"
                  >
                    Sign in
                  </button>
                </p>
            ...
            {!forgotSubmitted ? (
              <>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-2xl text-xs text-slate-900 outline-none focus:border-blue-500"
                />
                <button
                  type="button"
                  onClick={() => setForgotSubmitted(true)}
                  className="w-full py-2.5 rounded-full font-bold text-xs bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white cursor-pointer"
                >
              ...
              <div className="text-center space-y-3 py-2">
                <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-700 border border-blue-300 flex items-center justify-center mx-auto">
                ...
                <p className="text-[10px] text-slate-500">
                  Institutional demo password is <span className="text-blue-700 font-mono font-bold">Scanova2026!</span> (or <span className="text-blue-700 font-mono font-bold">ScanovaAdmin2026!</span> for Admin).
                </p>
                <button
                  type="button"
                  onClick={() => {
