            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-3 gap-2.5">
                <button
                  ...
                  className={`p-3 rounded-2xl border text-center transition-all cursor-pointer ${role === 'radiologist' && email === 'radiologist@scanova.health'
                ...
                <button
                  ...
                  className={`p-3 rounded-2xl border text-center transition-all cursor-pointer ${role === 'clinician' && email === 'clinician@scanova.health'
                      ? 'bg-emerald-600 text-white font-bold border-emerald-600 shadow-md'
                      : 'bg-slate-50 border-slate-200 text-slate-700 hover:bg-emerald-50/50 hover:border-emerald-300'
                    }`}
                >
                ...
                <button
                  ...
                  className={`p-3 rounded-2xl border text-center transition-all cursor-pointer ${role === 'admin' && email === 'admin@scanova.health'
                      ? 'bg-emerald-600 text-white font-bold border-emerald-600 shadow-md'
                      : 'bg-slate-50 border-slate-200 text-slate-700 hover:bg-emerald-50/50 hover:border-emerald-300'
                    }`}
                >
