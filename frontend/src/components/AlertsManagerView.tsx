    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 sm:p-8 rounded-3xl bg-white/95 border border-slate-200/90 shadow-xl shadow-slate-200/50 backdrop-blur-md relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-1.5">
          <div className="flex items-center space-x-2">
            <span className="px-3 py-1 rounded-full text-[10px] uppercase font-mono font-bold bg-rose-50 text-rose-700 border border-rose-200 shadow-sm">
        ...
        <div className="relative z-10">
          <button
            type="button"
            onClick={loadAlerts}
            className="flex items-center space-x-2 px-5 py-2.5 rounded-2xl bg-white border border-slate-200 hover:bg-slate-50 hover:border-slate-300 text-xs font-bold text-slate-700 transition-all shadow-sm cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-5 rounded-3xl bg-white border border-slate-200/90 shadow-sm flex items-center justify-between">
          <div>
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Active Open Incidents</span>
            <p className="text-2xl font-black text-slate-900 mt-1 font-display font-mono">{openCount}</p>
          </div>
        ...
        <div className="p-5 rounded-3xl bg-white border border-rose-200 shadow-sm flex items-center justify-between">
          <div>
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Critical Severity (24h SLA)</span>
            <p className="text-2xl font-black text-rose-600 mt-1 font-display font-mono">{criticalCount}</p>
          </div>
        ...
        <div className="p-5 rounded-3xl bg-white border border-slate-200/90 shadow-sm flex items-center justify-between">
          <div>
            <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Resolved Incidents</span>
            <p className="text-2xl font-black text-emerald-600 mt-1 font-display font-mono">{resolvedCount}</p>
          </div>
      ...
      <div className="p-4 rounded-3xl bg-white border border-slate-200/90 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-2xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-blue-500 font-sans"
          />
        </div>
          ...
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-50 text-slate-500 uppercase text-[10px] tracking-wider border-b border-slate-200">
              <tr>
                ...
                <th className="py-3 px-3.5 font-bold">Alert Type</th>
                <th className="py-3 px-3.5 font-bold">Title & Diagnostic Summary</th>
                <th className="py-3 px-3.5 font-bold">SLA Countdown</th>
                <th className="py-3 px-3.5 font-bold">Status</th>
                <th className="py-3 px-3.5 text-right font-bold">Actions</th>
              </tr>
            </thead>
                        ...
                        <>
                          {a.status === 'Open' && (
                            <button
                              ...
                              className="px-3 py-1 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 text-[11px] font-bold transition-colors cursor-pointer shadow-sm"
                            >
                              Investigate
                            </button>
                          )}
                          <button
                            ...
                            className="px-3 py-1 rounded-xl bg-blue-50 hover:bg-blue-100 border border-blue-200 text-blue-700 text-[11px] font-bold transition-colors cursor-pointer shadow-sm"
                          >
                            Resolve
                          </button>
                        </>
      ...
      {resolvingAlert && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fadeIn">
          <div className="w-full max-w-lg bg-white border border-slate-200 rounded-3xl shadow-2xl overflow-hidden p-6 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              ...
              <button onClick={() => setResolvingAlert(null)} className="text-slate-400 hover:text-slate-600 cursor-pointer">
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <form onSubmit={handleResolveSubmit} className="space-y-3">
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-2xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-blue-500 font-sans"
                />
              </div>
              ...
              <div className="flex items-center justify-end space-x-2 pt-2">
                <button
                  ...
                  className="px-4 py-2 rounded-2xl bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 text-xs font-bold cursor-pointer"
                >
                  Cancel
                </button>
                <button
